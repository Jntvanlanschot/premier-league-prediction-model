#!/usr/bin/env python3
"""
Premier League Web Predictor
===========================
Creates a web interface for displaying upcoming games with predictions,
odds, recent form data, and Win/Draw/Loss probabilities.
"""
...
class WebPredictor:
    """Web predictor for Premier League games."""
        ...
        for game in upcoming_games:
            ...
            for col in self.feature_columns:
                if col.startswith('team_'):
                    ...
                    # Use market odds if available, otherwise use default
                    if 'odds' in game:
    ...
    def generate_web_data(self):
        ...
        # Sample upcoming games (you can replace this with real upcoming fixtures)
        upcoming_games = [
            {
                'home_team': 'Arsenal',
                'away_team': 'Chelsea',
...
def main():
    ...
    print("🌐 Generating Premier League Web Predictor Data")
    print("=" * 50)
